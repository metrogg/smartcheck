...
| 5 | `/api/records` | GET | 批量查询晨检记录 |
| 6 | `/api/records/{id}` | GET | 查询单条记录详情 |
| 7 | `/api/records/sync` | GET | 增量同步 |
| 8 | `/api/records/statistics` | GET | 统计汇总 |
| 9 | `/api/records/export` | POST | 导出 CSV 文件 |
| 10 | `/api/images/{filename}` | GET | 下载晨检图片 |
| 11 | `/api/employee-images/{filename}` | GET | 下载员工照片 |
| 12 | `/api/users/sync` | POST | 账号信息同步 |
