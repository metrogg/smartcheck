...
| 2 | `/api/users/sync` | POST | 账号信息同步 |
| 3 | `/api/records` | GET | 批量查询晨检记录 |
| 4 | `/api/records/{id}` | GET | 查询单条记录详情 |
| 5 | `/api/records/sync` | GET | 增量同步 |
| 6 | `/api/records/statistics` | GET | 统计汇总 |
| 7 | `/api/records/export` | POST | 导出 CSV 文件 |
| 8 | `/api/images/{filename}` | GET | 下载图片 |
